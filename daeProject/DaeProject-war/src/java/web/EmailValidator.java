...
public class EmailValidator implements Validator {
    ...
    private static final Logger logger = Logger.getLogger("web.EmailValidator");
    ...
    public void validate(FacesContext context, UIComponent toValidate, Object value) throws ValidatorException {
        try {
            ...
            if (email.startsWith("xpto")) {
                FacesMessage message = new FacesMessage("Error: invalid email.");
